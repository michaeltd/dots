...
** [[dot.files][dot.files]]
*** [[dot.files/.bash_profile][Shell]], [[dot.files/.xinitrc][X setup]], [[dot.files/.local/bin][bin]], [[dot.files/sbin/][sbin]] (maintenance scripts)
...
**** [[dot.files/sbin/update_backups.bash][update_backups.bash]]
     Back up things ...

**** [[dot.files/sbin/update_cleanup.bash][update_cleanup.bash]]
...
** Business Cards
   ...
   +  [[dot.files/.local/bin/michaeltd][Terminal buisiness card v1.0]]
...
** Contributing [[http://unmaintained.tech/][http://unmaintained.tech/badge.svg]]
   ...
   Other than that and unless your mind reading game is top notch, try your luck with a PR.

   Now in the rare case that you *really* must contribute, feel free to buy me some coffee in [[https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3THXBFPG9H3YY&source=michaeltd/.emacs.d][\euro]] or [[bitcoin:19TznUEx2QZF6hQxL64bf3x15VWNy8Xitm][₿]] (bitcoin:19TznUEx2QZF6hQxL64bf3x15VWNy8Xitm).
