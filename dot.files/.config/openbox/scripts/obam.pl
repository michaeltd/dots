...
# my $APPSDIR = "/usr/share/applications/ ~/.local/share/applications/ /usr/kde/3.5/share/applications/kde/ ~/.gnome/apps/ ~/.kde/share/apps";

my $APPSDIR = "/usr/share/applications/ ~/.local/share/applications/ /usr/local/share/applications/";
